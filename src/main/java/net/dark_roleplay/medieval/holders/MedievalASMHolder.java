...
public class MedievalASMHolder {
	...
	// public static final ResourceLocation ASM_FILE = new
	// ResourceLocation(References.MODID, "asms/block/simple_chest_top.json");
	...
	// public static final ResourceLocation ASM_FILE = new
	// ResourceLocation(References.MODID, "asms/block/hone_centrifuge.json");
