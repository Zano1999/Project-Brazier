...
public class MedievalModels {
    ...
    public static void registerModels(ModelRegistryEvent event){
        ...
        plankMat.execute(material -> {
            ...
            ModelLoader.addSpecialModel(new ResourceLocation(DarkRoleplayMedieval.MODID, material.getTextProv().searchAndReplace("other/simple_${material}_arrow_sign_left")));
            ModelLoader.addSpecialModel(new ResourceLocation(DarkRoleplayMedieval.MODID, material.getTextProv().searchAndReplace("other/simple_${material}_arrow_sign_right")));
        });
    }
}
