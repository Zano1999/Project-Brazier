...
public class ModelBakeListener {
    ...
    public static void onModelBakeEvent(ModelBakeEvent event){
        ...
        planks.execute(material -> {
            try {
                IModel<?> roadSignLeft = ModelLoaderRegistry.getModel(new ResourceLocation(material.getTextProv().searchAndReplace("drpmedieval:other/road_signs/${material}_road_sign_left.obj")));

                RoadSignTileEntityRenderer.bakedCache.put(
                        new ResourceLocation(material.getTextProv().searchAndReplace("drpmedieval:${material}_road_sign_left.obj")),
            ...
            try {
                IModel<?> roadSignRight = ModelLoaderRegistry.getModel(new ResourceLocation(material.getTextProv().searchAndReplace("drpmedieval:other/road_signs/${material}_road_sign_right.obj")));

                RoadSignTileEntityRenderer.bakedCache.put(
                        new ResourceLocation(material.getTextProv().searchAndReplace("drpmedieval:${material}_road_sign_right.obj")),
