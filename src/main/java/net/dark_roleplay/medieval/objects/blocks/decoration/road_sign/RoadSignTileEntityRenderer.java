...
public class RoadSignTileEntityRenderer extends TileEntityRenderer<RoadSignTileEntity> {
	...
	public RoadSignTileEntityRenderer(TileEntityRendererDispatcher renderDispatcher) {
		super(renderDispatcher);
	}

	@Override
	public void render(RoadSignTileEntity tileEntity, float v, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int i, int i1) {
		...
		for (SignInfo sign : signs) {
			...
			float ig = 0F;// this.getFontRenderer().getStringWidth(sign.getText());
