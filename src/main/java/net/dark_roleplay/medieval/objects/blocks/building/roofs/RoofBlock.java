...
public class RoofBlock extends HorizontalBlock {
    ...
    public static final EnumProperty<RoofSegment> SEGMENT = EnumProperty.create("segment", RoofSegment.class, type -> type.isNormalType());
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        if(behind.getBlock() instanceof RoofBlock) {
        ...
        if(front.getBlock() instanceof RoofBlock) {
