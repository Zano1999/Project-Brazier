package net.dark_roleplay.medieval.features.screens;
...
public class SpyglassOverlay extends AbstractGui implements IRenderable {
	...
	private static final ResourceLocation SPYGLASS_OVERLAY = new ResourceLocation(DarkRoleplayMedieval.MODID, "textures/screen/spyglass_overlay.png");
