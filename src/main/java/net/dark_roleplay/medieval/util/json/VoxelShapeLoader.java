package net.dark_roleplay.medieval.util.json;
...
public class VoxelShapeLoader {
	...
	public static VoxelShape getVoxelShape(String name){
		try (JsonReader reader = new JsonReader(new InputStreamReader(VoxelShapeLoader.class.getClassLoader().getResourceAsStream("fixed_data/drpmedieval/voxel_shapes/" + name + ".json")))) {
