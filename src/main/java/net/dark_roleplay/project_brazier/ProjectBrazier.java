...
import net.dark_roleplay.project_brazier.features.model_loaders.axis_connected_models.AxisConnectedModel;
import net.dark_roleplay.project_brazier.features.model_loaders.emissive.EmissiveModel;
import net.dark_roleplay.project_brazier.features.model_loaders.simple_pane_conneted_model.SimplePaneConnectedModel;
import net.dark_roleplay.project_brazier.handler.*;
...
//        MedievalContainers.CONTAINERS.register(FMLJavaModLoadingContext.get().getModEventBus());
    ...
    public void setupClientStuff(FMLClientSetupEvent event) {
        ...
        DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> {
            ...
            //ProjectBrazierClient.regoatisterRenderLayers();
        });
    }
}
