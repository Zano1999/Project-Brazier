...
public class PlacementPreviewHelpers {
	...
	@SubscribeEvent
	public static void preview(RenderLevelLastEvent event) {
...
//				renderBuffer.finish();
	...
	private static MultiBufferSource.BufferSource initRenderBuffer(MultiBufferSource.BufferSource original) {
		BufferBuilder fallback = ObfuscationReflectionHelper.getPrivateValue(MultiBufferSource.BufferSource.class, original, "builder");
		Map<RenderType, BufferBuilder> layerBuffers = ObfuscationReflectionHelper.getPrivateValue(MultiBufferSource.BufferSource.class, original, "fixedBuffers");
		...
		return new MultiBufferSource.BufferSource(fallback, remapped) {
			@Override
